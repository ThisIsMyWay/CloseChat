package com.closechat.closechat.imageshare.helpers;
...
import com.closechat.closechat.R;
...
public class NotificationHelper {
    ...
    public void createUploadingNotification() {
        ...
        mBuilder.setContentTitle(mContext.get().getString(R.string.upload_progress_notify));
    ...
    public void createUploadedNotification(ImageResponse response) {
        ...
        mBuilder.setContentTitle(mContext.get().getString(R.string.upload_succed_notify));
    ...
    public void createFailedUploadNotification() {
        ...
        mBuilder.setContentTitle(mContext.get().getString(R.string.upload_fail_notify));
